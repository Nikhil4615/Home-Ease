            ...
            <div className={styles.container}>
                ...
                {bookings.length === 0 ? (
                    <div className={styles.panel} style={{textAlign: 'center', padding: '2rem'}}>
                        ...
                        <Link href="/" className={serviceStyles.addToCartButton}>
                            Explore Services
                    ...
                    <>
                        ...
                        <div className={serviceStyles.subServiceGrid}>
                            {bookings.map((booking) => (
                                ...
                                >
                                    <div className={serviceStyles.cardImage}>
                                    ...
                                    <div className={serviceStyles.cardContent}>
                                        ...
                                        <div className={bookingStyles.bookingMetadata}>
                                        ...
                                        <div className={serviceStyles.cardDetails}>
                                            <p className={serviceStyles.cardPrice}>${booking.price.toFixed(2)}</p>
                                            <p className={bookingStyles.bookingId}>ID: {booking.id.substring(0, 8)}</p>
                                        </div>
